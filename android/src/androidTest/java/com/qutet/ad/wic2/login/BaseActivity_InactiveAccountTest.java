...
/**
 * UI tests for {@link com.qutet.ad.wic2.ui.BaseActivity} when the user has no active
 * account.
 */
...
public class BaseActivity_InactiveAccountTest {
     ...
     * com.qutet.ad.wic2.welcome.WelcomeActivity}. On API 17+, the activity checks the
