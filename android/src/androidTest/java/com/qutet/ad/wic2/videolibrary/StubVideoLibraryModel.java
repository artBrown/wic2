...
import com.qutet.ad.wic2.archframework.QueryEnumHelper;
...
/**
 * A stub {@link VideoLibraryModel}, to be injected using {@link com.qutet.ad.wic2
 * .injection.Injection}. It overrides {@link #requestData(QueryEnum, DataQueryCallback)} to bypass
 * the loader manager mechanism. Use the classes in {@link com.qutet.ad.wic2.mockdata}
