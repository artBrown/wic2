...
import com.qutet.ad.wic2.archframework.ModelWithLoaderManager;
import com.qutet.ad.wic2.archframework.PresenterImpl;
import com.qutet.ad.wic2.archframework.UpdatableView;
import com.qutet.ad.wic2.explore.ExploreIOModel.ExploreIOQueryEnum;
import com.qutet.ad.wic2.explore.ExploreIOModel.ExploreIOUserActionEnum;
import com.qutet.ad.wic2.explore.data.EventData;
import com.qutet.ad.wic2.explore.data.ItemGroup;
import com.qutet.ad.wic2.explore.data.LiveStreamData;
import com.qutet.ad.wic2.explore.data.MessageData;
import com.qutet.ad.wic2.explore.data.SessionData;
import com.qutet.ad.wic2.injection.ModelProvider;
import com.qutet.ad.wic2.provider.ScheduleContract;
import com.qutet.ad.wic2.session.SessionDetailActivity;
import com.qutet.ad.wic2.settings.ConfMessageCardUtils;
import com.qutet.ad.wic2.settings.SettingsUtils;
import com.qutet.ad.wic2.ui.widget.DrawShadowFrameLayout;
import com.qutet.ad.wic2.ui.widget.recyclerview.ItemMarginDecoration;
import com.qutet.ad.wic2.ui.widget.recyclerview.UpdatableAdapter;
import com.qutet.ad.wic2.util.AccountUtils;
import com.qutet.ad.wic2.util.ImageLoader;
import com.qutet.ad.wic2.util.ThrottledContentObserver;
import com.qutet.ad.wic2.util.TimeUtils;
import com.qutet.ad.wic2.util.UIUtils;

import java.util.ArrayList;
import java.util.List;

import static android.content.SharedPreferences.OnSharedPreferenceChangeListener;
import static com.qutet.ad.wic2.settings.ConfMessageCardUtils.ConferencePrefChangeListener;
