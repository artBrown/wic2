...
import com.qutet.ad.wic2.navigation.NavigationModel;
import com.qutet.ad.wic2.provider.ScheduleContract;
import com.qutet.ad.wic2.ui.BaseActivity;
import com.qutet.ad.wic2.util.AnalyticsHelper;
import com.qutet.ad.wic2.util.PermissionsUtils;

import static com.qutet.ad.wic2.util.LogUtils.makeLogTag;

/**
 * Activity that displays a {@link com.qutet.ad.wic2.map.MapFragment} and a {@link
 * com.qutet.ad.wic2.map.MapInfoFragment}. Supports 'detached' mode, where the toolbar
 ...
 * marker.
 *
 * @see com.qutet.ad.wic2.map.MapInfoFragment#newInstace(android.content.Context)
 */
public class MapActivity extends BaseActivity
     ...
     */
    public static final String EXTRA_ROOM = "com.google.android.wic2.extra.ROOM";

    public static final String EXTRA_DETACHED_MODE
            = "com.qutet.ad.wic2.EXTRA_DETACHED_MODE";
     ...
     * <p/>
     * For {@link com.qutet.ad.wic2.map.InlineInfoFragment} (that is only displayed on
     * the left of the screen), the full extend of its container layout (including padding) is
     * passed to the map fragment. For {@link com.qutet.ad.wic2.map
