...
package com.qutet.ad.wic2.provider;

import com.qutet.ad.wic2.Config;
import com.qutet.ad.wic2.appwidget.ScheduleWidgetProvider;
import com.qutet.ad.wic2.provider.ScheduleContract.Announcements;
import com.qutet.ad.wic2.provider.ScheduleContract.Blocks;
import com.qutet.ad.wic2.provider.ScheduleContract.Feedback;
import com.qutet.ad.wic2.provider.ScheduleContract.HashtagColumns;
import com.qutet.ad.wic2.provider.ScheduleContract.Hashtags;
import com.qutet.ad.wic2.provider.ScheduleContract.MapMarkers;
import com.qutet.ad.wic2.provider.ScheduleContract.MapTiles;
import com.qutet.ad.wic2.provider.ScheduleContract.MyFeedbackSubmitted;
import com.qutet.ad.wic2.provider.ScheduleContract.MySchedule;
import com.qutet.ad.wic2.provider.ScheduleContract.MyScheduleColumns;
import com.qutet.ad.wic2.provider.ScheduleContract.MyViewedVideos;
import com.qutet.ad.wic2.provider.ScheduleContract.Rooms;
import com.qutet.ad.wic2.provider.ScheduleContract.SearchSuggest;
import com.qutet.ad.wic2.provider.ScheduleContract.SearchTopicsSessions;
import com.qutet.ad.wic2.provider.ScheduleContract.Sessions;
import com.qutet.ad.wic2.provider.ScheduleContract.Speakers;
import com.qutet.ad.wic2.provider.ScheduleContract.Tags;
import com.qutet.ad.wic2.provider.ScheduleContract.VideoColumns;
import com.qutet.ad.wic2.provider.ScheduleContract.Videos;
import com.qutet.ad.wic2.provider.ScheduleDatabase.SessionsSearchColumns;
import com.qutet.ad.wic2.provider.ScheduleDatabase.SessionsSpeakers;
import com.qutet.ad.wic2.provider.ScheduleDatabase.Tables;
import com.qutet.ad.wic2.settings.SettingsUtils;
import com.qutet.ad.wic2.util.AccountUtils;
import com.qutet.ad.wic2.util.SelectionBuilder;
...
import static com.qutet.ad.wic2.util.LogUtils.LOGV;
 ...
 * usually inserted by {@link com.qutet.ad.wic2.sync.SyncHelper}, and queried using
...
public class ScheduleProvider extends ContentProvider {
     ...
     * parameter is used by the {@link com.qutet.ad.wic2.explore.ExploreSessionsActivity}
     ...
     * {@link com.qutet.ad.wic2.sync.ConferenceDataHandler} notifies all top level
     * conference paths once the conference data sync is done, and the
     * {@link com.qutet.ad.wic2.sync.userdata.AbstractUserDataSyncHelper} notifies all
