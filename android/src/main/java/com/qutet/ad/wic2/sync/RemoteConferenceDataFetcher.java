...
import com.qutet.ad.wic2.io.model.DataManifest;
import com.qutet.ad.wic2.util.AccountUtils;
import com.qutet.ad.wic2.util.HashUtils;
import com.qutet.ad.wic2.util.IOUtils;
...
public class RemoteConferenceDataFetcher {
    ...
    private static final String URL_OVERRIDE_FILE_NAME = "wic2_manifest_url_override.txt";
    ...
    private static final String MANIFEST_FORMAT = "wic2-json-v1";
