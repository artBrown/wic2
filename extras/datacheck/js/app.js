(function(context) {
  var BASE='http://storage.googleapis.com/wic2-updater-dev.appspot.com/';
  ...
  Board.prototype.handleRawIoSchedData = function(e) {
    ...
    if (data == null || ! ("sessions" in data)) {
      console.log(e);
      window.alert("invalid wic2 data, check console");
      return;
    }
    this.wic2Data = {};
    for (var i=0; i<data["sessions"].length; i++) {
      var session = data["sessions"][i];
      this.wic2Data[session["id"]] = session;
    }
  }
  ...
  Board.prototype.handleRawData = function(e) {
    ...
    for (var i=0; i<data["topics"].length; i++) {
      ...
      cell.style.backgroundImage = "url('http://storage.googleapis.com/wic2-updater-dev.appspot.com/images/sessions/w200/"+topic["id"]+".jpg')";
      ...
      var linkImg = cell.querySelector(".wic2_img");
      linkImg.href = 'http://storage.googleapis.com/wic2-updater-dev.appspot.com/images/sessions/w1000/'+topic["id"]+".jpg";
      ...
      var wic2Data = cell.querySelector(".data_from_wic2");
      ...
      wic2Data.addEventListener('click', function(id, e) {
        this.showData(this.wic2Data[id]);
        e.preventDefault();
        e.stopPropagation();
      }.bind(this, topic["id"]));
